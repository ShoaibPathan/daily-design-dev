# March 10, 2020 - Day 13

* Data Models and Image Literals (designcode.io swiftui)

### Notes

* Use `Identifiable` to ensure the default `id` property is used in data models
* ColorLiteral and ImageLiteral can be used in place of Image() and Color()
