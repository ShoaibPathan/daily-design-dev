...
* k: scale tool (fonts will scale too)
* cmd+: zoomin
* cmd-: zoomout
* fix position when using constraints (header bar)
* boolean grouping for shapes
* when scaling items, check sizes for fractional values
* cmd+d when frame is selected: duplicate frame
* frame layouts (iphone versions, android..etc)
* v: move tool
* k: scale tool

### Swift UI Course

* Circle Button Animation - designcode.io swiftui
* Tap Progress Animation - designcode.io swiftui
* Use `.updating` instead of `.onChanged` to be able to update the current gesture state 
...
//  meditate
//
//  Created by Thomas Holloway on 3/31/20.
...
struct CircleButton: View {
    ...
    var body: some View {
        ...
        .background(
            ZStack {
                LinearGradient(gradient: Gradient(colors: [Color(press ? #colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1, alpha: 1) : #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)), Color(press ? #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0) : #colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1, alpha: 1))]), startPoint: .topLeading, endPoint: .bottomTrailing)
                Circle()
    ...
    var body: some View {
        ...
        .overlay(
            Circle()
                ...
                .stroke(LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1)), Color(#colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1))]), startPoint: .topLeading, endPoint: .bottomTrailing), style: StrokeStyle(lineWidth: 6, lineCap: .round))
